function homePage() {
    ...
    let iconHost = 'https://raw.githubusercontent.com/pjdkj/src/refs/heads/main/icon';
    ...
    layouts.push({
        ...
        url: $('hiker://empty').rule((iconHost) => {
            ...
            let ymsc = ["短发", "马尾", "双马尾", "丸子头", "巨乳", "乳环", "舌环", "贫乳", "黑皮肤", "晒痕", "眼镜娘", "兽耳", "尖耳朵", "异色瞳", "美人痣", "肌肉女", "白虎", "阴毛", "腋毛", "大屌", "着衣", "水手服", "体操服", "泳装", "比基尼", "死库水", "和服", "兔女郎", "围裙", "啦啦队", "丝袜", "吊袜带", "热裤", "迷你裙", "性感内衣", "紧身衣", "丁字裤", "高跟鞋", "睡衣", "婚纱", "旗袍", "古装", "哥德", "口罩", "刺青", "淫纹", "身体写字"];
            ...
            let layouts = [];
            layouts.push({
                title: small('广泛配对') + '\n' + small('匹配所以包含任一标签的影片，而非全部标签。'),
                img: getItem('broad', '') == 'on' ? iconHost + '/开.svg' : iconHost + ' / 关.svg',
                url: $('#noLoading#').lazyRule(() => {
                    if (getItem('broad', '') == 'on') {
                        setItem('broad', '');
                        updateItem('broad', { img: iconHost + '/关.svg' });
                    }
                    else {
                        setItem('broad', 'on');
                        updateItem('broad', { img: iconHost + '/开.svg' });
                    }
                    return 'hiker://empty';
                }),
                col_type: 'text_icon',
            ...
            setResult(layouts);
            //setResult(setTags(params, iconHost));
        }, iconHost),
        col_type: 'text_5'
    });
